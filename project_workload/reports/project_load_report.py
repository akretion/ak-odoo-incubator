...
class ProjectLoadReport(models.TransientModel):
    ...
    line_ids = fields.One2many("project.load.report.line", "report_id", "Lines")
    ...
    def _generate_lines(self):
        ...
        self.env.cr.execute(
            """
            INSERT INTO project_load_report_line (
                report_id,
                ...
                SELECT
                    ...
                    project_capacity_hours - match_project_planned_hours as project_available_hours,
    ...
    def open_report(self):
        self.refresh_lines()
        action = (
            self.env.ref("project_workload.project_load_report_line_action")
            .sudo()
            .read()[0]
        )
...
class ProjectLoadReportLine(models.TransientModel):
    _name = "project.load.report.line"
    ...
    report_id = fields.Many2one("project.load.report", "Report")
