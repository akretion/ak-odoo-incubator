...
class ResUsersRole(models.Model):
    ...
    _inherit = ["res.users.role", "res.users.role.description"]

    recursive_model_access_ids = fields.Many2many(
        comodel_name="ir.model.access",
        compute="_compute_recursive_model_access_ids",
    ...
    def _compute_recursive_model_access_ids(self):
        for rec in self:
