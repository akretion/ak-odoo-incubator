odoo.define("open_in_new_tab.tree_view", function (require) {
    ...
    ListRenderer.include({
        ...
        _renderExternalLinkHeader: function () {
            ...
            return $("<th>").addClass("o_list_record_selector").append($content);
        },
        _renderExternalLink: function (url) {
            ...
            return $("<td>").addClass("o_list_record_selector").append($content);
        },
        ...
        _renderGroupRow: function (group, groupLevel) {
            ...
            if (firstAggregateIndex !== -1) {
                ...
                var lastAggregateIndex = _.findLastIndex(this.columns, function (
                    column
                ) {
                    return (
                        column.tag === "field" &&
